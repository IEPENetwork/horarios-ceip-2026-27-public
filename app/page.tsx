...
const schedule = scheduleSource as unknown as Omit<typeof scheduleSource, "lessons" | "teacherLoads" | "teacherRoles"> & { lessons: Lesson[]; teacherLoads: Record<string, Load>; teacherRoles: Record<string, string[]> };
