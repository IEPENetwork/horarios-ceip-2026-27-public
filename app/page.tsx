...
function SubstitutionsView() {
  ...
  return <><div className="sub-tabs"><button className={view === "resolver" ? "active" : ""} onClick={() => setView("resolver")}>Resolver faltas</button><button className={view === "availability" ? "active" : ""} onClick={() => setView("availability")}>Disponibilidad por franja</button><button className={view === "support" ? "active" : ""} onClick={() => setView("support")}>Apoyos disponibles</button><button className={view === "dashboard" ? "active" : ""} onClick={() => setView("dashboard")}>Dashboard e historial</button></div>
